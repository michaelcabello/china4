...
<head>
  ...
  <title>Portal Médico - Panel de Administración</title>
...
<?php
 ...
 if(isset($_SESSION["validarSesionUsuario"]) && $_SESSION["validarSesionUsuario"] === "okchina"){
   ...
   if(isset($_GET["ruta"])){
        ...
        if($_GET["ruta"]== "registrate" || $_GET["ruta"]== "login" || $_GET["ruta"]== "recuperar"){
