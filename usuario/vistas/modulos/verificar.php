			...
			<?php
				...
				if($usuarioVerificado){
					...
					echo '<h3>Gracias</h3>
						...
						<a href="usuario/login"><button class="btn btn-default backColor btn-lg">INGRESAR</button></a>';
					...
					<a href="usuario/registrate"><button class="btn btn-default backColor btn-lg">REGISTRO</button></a>';
